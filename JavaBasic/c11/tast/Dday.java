...
public class Dday {
	public static void main(String[] args) {
		...
		Period p=Period.between(inDate, curDay);
		
		//SimpleDateFormat sdf=
		//	new SimpleDateFormat("yyyy년 mm월 dd일");
		//String curDayFormated=sdf.format(inDate);
		
		//System.out.println("입력하신 날짜("
				//+curDayFormated+")와 현재 날짜의 차이");
		System.out.println(
			p.getYears()+"년 "+p.getMonths()+"개월 "
			+p.getDays()+"일"
		);
	}
